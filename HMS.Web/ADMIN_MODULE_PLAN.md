...
- [x] **3.3 Teller Implementation**
  ...
  - [ ] **Shift Automation**: Remove manual Start/End buttons. Auto-start shift on Login, auto-close on Logout.
- [x] **3.4 Detailed Surgical Billing (Enhanced)**
  ...
  - [ ] **Team Notifications**: Notify Doctors and assigned Staff when a patient operation is scheduled/admitted.
...
- [ ] **4.2 Enterprise Doctor Settlements (The "Audit")**
  - [x] **Schema Upgrade**: Add OperatingSurgeonId to Operations and 3-part Pay Profile (Consult/Rec/Surgery) to Doctors.
  - [x] **Settlement Ledger**: Create immutable ledger for accruing fees (Pending -> Approved -> Paid).
  - [x] **Role triggers**: Auto-generate ledger entries for Completed Appointments (Consult Fee) and Operations (Rec/Surgery Fee).
  - [x] **Approval Workflow**: Admin dashboard to validate patient payment before releasing doctor payout (/admin/doctor-ledger).
